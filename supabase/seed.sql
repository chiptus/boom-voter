...
INSERT INTO public.profiles (id, username, email, created_at) VALUES 
  ('11111111-1111-1111-1111-111111111111', 'admin', 'admin@festival.com', now()),
  ('22222222-2222-2222-2222-222222222222', 'alice_music', 'alice@example.com', now()),
  ('33333333-3333-3333-3333-333333333333', 'bob_beats', 'bob@example.com', now()),
  ('44444444-4444-4444-4444-444444444444', 'charlie_vibes', 'charlie@example.com', now()),
  ('55555555-5555-5555-5555-555555555555', 'diana_dance', 'diana@example.com', now()),
  ('66666666-6666-6666-6666-666666666666', 'eve_electronic', 'eve@example.com', now());
