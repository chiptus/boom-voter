        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                By accessing and using this festival voting application, you accept and agree to be bound by the terms and provision of this agreement.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                This application provides a collaborative platform for voting on and rating festival artists. 
                Users can create groups, share voting lists, and discover new artists through community recommendations.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>By submitting content, you grant us a license to use, modify, and display that content within the service</li>
                <li>You are responsible for ensuring you have the right to submit any content you share</li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                to understand our practices regarding the collection, use, and disclosure of personal information.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                this Company excludes all warranties, representations, or terms relating to this service and its use.
              </p>
            </section>
