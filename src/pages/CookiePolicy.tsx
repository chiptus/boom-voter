          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                They help us provide you with a better experience by remembering your preferences and improving functionality.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                We use cookies and similar technologies to enhance your experience on our festival voting application. 
                Our approach is privacy-first - we only use essential cookies required for the app to function properly.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <strong>Purpose:</strong> Remembers whether you prefer the sidebar expanded or collapsed
                    </div>
                    <div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <strong>Purpose:</strong> Remembers your cookie consent preferences
                    </div>
                    <div>
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-lg mb-2">Offline Storage</h3>
                  <p className="text-muted-foreground mb-3">
                    We use browser storage to provide offline functionality for a better user experience.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div>
                    ...
                    <div>
                      <strong>Purpose:</strong> Cache artist data, votes, and notes for offline access
                    </div>
                    <div>
                      <strong>Duration:</strong> Until manually cleared or app uninstalled
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <p className="text-muted-foreground">
                  We want to be transparent about what we <strong>don't</strong> use:
                </p>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li><strong>Cookie Consent Banner:</strong> When you first visit, you can choose which cookies to accept</li>
                <li><strong>Cookie Preferences:</strong> Use the "Cookie Preferences" button in the footer to change your settings</li>
                <li><strong>Reset Consent:</strong> Use the "Reset Consent" button to clear all stored preferences</li>
                <li><strong>Browser Settings:</strong> Configure your browser to block or delete cookies</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-semibold">6. Impact of Blocking Cookies</h2>
              <p className="text-muted-foreground">
                If you choose to block our essential cookies:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>The app will still function normally</li>
                <li>Your sidebar preference won't be remembered between sessions</li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                We do not use any third-party cookies or tracking technologies. All data storage is handled directly by our application 
                and stored locally in your browser or on our secure servers.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                We will notify you of any significant changes by updating the date at the top of this policy.
              </p>
            </section>
