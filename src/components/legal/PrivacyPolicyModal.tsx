          ...
          <div className="space-y-6 pr-4">
            ...
            <section>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p><strong>Account Information:</strong> Email address, username, account creation date</p>
                <p><strong>Voting Data:</strong> Your votes on festival artists, voting timestamps</p>
                <p><strong>Personal Notes:</strong> Notes you create about artists</p>
                <p><strong>Group Data:</strong> Group memberships, roles, and related activity</p>
                <p><strong>Technical Data:</strong> Browser preferences (sidebar state), offline cached data</p>
              </div>
            </section>

            <section>
              <h3 className="text-lg font-semibold mb-3">3. Legal Basis for Processing</h3>
              <div className="space-y-2 text-sm text-muted-foreground">
                <p><strong>Contract Performance:</strong> Processing necessary to provide the voting service you requested</p>
                <p><strong>Legitimate Interest:</strong> Improving the app functionality and user experience</p>
                <p><strong>Consent:</strong> For optional features like preference cookies</p>
              </div>
            </section>

            <section>
              <h3 className="text-lg font-semibold mb-3">4. How We Use Your Data</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold mb-3">7. Your Rights Under GDPR</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
            ...
            <section>
              <h3 className="text-lg font-semibold mb-3">12. Updates to This Policy</h3>
              <p className="text-sm text-muted-foreground">
